...
$(function () {
  const form = $('#sixth-month-performance-evaluation-form');
  $('.select2').select2({
          ...
          success: function (data) {
            Swal.fire({
              ...
              if (data.message === 'Success') {
                window.location.href = '/form/view/sixth-month-performance-evaluation-form/' + data.form_id;
              }
            });
          },
  ...
  //Edit
  $('#sixth_month_performance_evaluation_form_edit').on('submit', function (e) {
    e.preventDefault(); // Prevent the default form submission
