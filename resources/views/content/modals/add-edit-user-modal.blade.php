...
<div class="modal fade" id="staff_modal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-xl"> {{-- Increased modal size to modal-xl --}}
    <form id="staff_form" action="/staffs/store" method="POST">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-3 mb-3">
              ...
              <select class="selectpicker w-100" data-style="default" id="gender" name="gender">
          ...
          <div class="row mt-5">
            <div class="d-grid d-md-flex justify-content-md-end">
              <button type="submit" class="btn btn-primary" id="modal_button">Add Staff</button>
            </div>
          </div>
        </div>
      </div>
