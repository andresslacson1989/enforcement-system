                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if($detachment->category != 'Single Post')
                                            <div class="mb-3">
                                                <label for="assigned_officer" class="form-label">Assigned Officer (Commander)</label>
                                                <select
                                                    class="select2-edit-detachment form-control"
                                                    id="assigned_officer"
                                        ...
                                        @else
                                            <label for="assigned_officer" class="form-label">Assigned Officer (Commander)</label>
                                            <input class="form-control" type="text" readonly disabled value="N/A for Single Post">
                                        @endif
                                    </div>
                                </div>
                                <!-- Location Card -->
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3"><label for="thirteenth_month_pay" class="form-label">13th Month Pay</label><input type="text" class="form-control" id="thirteenth_month_pay"
                                                                                                                                                          name="thirteenth_month_pay"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
