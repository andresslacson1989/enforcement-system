        ...
        <tr>
          <td>
            ...
            <div class="mt-2">
              ...
              <input class="form-check-input ms-5" type="checkbox" id="photocopy_certificate_of_employment" name="photocopy_certificate_of_employment" @if($submission->photocopy_certificate_of_employment ?? false) checked @endif>
