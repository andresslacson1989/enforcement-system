...
@section('page-script')
    @vite(['resources/assets/js/forms-third-month-performance-evaluation-form.js', 'resources/assets/js/forms-selects.js', 'resources/assets/js/extended-ui-sweetalert2.js'])
@endsection
                        ...
                        <div class="container-fluid p-4">
                            ...
                            <div class="row mt-3">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" name="strength_3" value="{{ $submission->strength_3 }}"
                                           placeholder="3.">
                                </div>
                                <div class="col-6">
                                ...
                                <div class="col-lg-9 mx-auto">
                                    ...
                                    <div class="row g-6">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input class="form-control" type="text" id="employee_number" name="employee_number"
                                                   aria-label="ID1234" aria-describedby="ID1234" value="" />
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <label class="form-label" for="detachment">Detachment</label>
                                            <input class="form-control" type="text" id="detachment_name" name="detachment_name"
                                                   value="{{ $deployment->name ?? '' }}" readonly />
                                            <input class="form-control" type="hidden" id="detachment_id" name="detachment_id"
                                                   value="{{ $deployment->id ?? '' }}" />
                                                ...
                                                <div class="col-12 p-3">
                                                    ...
                                                    <table class="table table-bordered table-sm performance-criteria-table"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Understanding of security protocols and procedure</td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="job_knowledge_a_poor_new" name="job_knowledge_a" value="poor"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="job_knowledge_a_fair_new" name="job_knowledge_a" value="fair"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="job_knowledge_a_good_new" name="job_knowledge_a" value="good"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="job_knowledge_a_excellent_new" name="job_knowledge_a" value="excellent">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="col-1">b.</td>
                                                            <td>Proficiency in using security equipment</td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="job_knowledge_b_poor_new" name="job_knowledge_b" value="poor"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="job_knowledge_b_fair_new" name="job_knowledge_b" value="fair"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="job_knowledge_b_good_new" name="job_knowledge_b" value="good"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="job_knowledge_b_excellent_new" name="job_knowledge_b" value="excellent">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="col-1">c.</td>
                                                            <td>Knowledge of emergency procedures</td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="job_knowledge_c_poor_new" name="job_knowledge_c" value="poor"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="job_knowledge_c_fair_new" name="job_knowledge_c" value="fair"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="job_knowledge_c_good_new" name="job_knowledge_c" value="good"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="job_knowledge_c_excellent_new" name="job_knowledge_c" value="excellent">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><input class="form-check-input" type="radio"           _
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Ability to handle security threats or incidents</td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="problem_solving_a_poor_new" name="problem_solving_a" value="poor"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="problem_solving_a_fair_new" name="problem_solving_a" value="fair"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="problem_solving_a_good_new" name="problem_solving_a" value="good"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Decision-making skills under pressure</td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="problem_solving_b_poor_new" name="problem_solving_b" value="poor"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="problem_solving_b_fair_new" name="problem_solving_b" value="fair"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="problem_solving_b_good_new" name="problem_solving_b" value="good"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>problem-solving skills</td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="problem_solving_c_poor_new" name="problem_solving_c" value="poor"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="problem_solving_c_fair_new" name="problem_solving_c" value="fair"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                                                                           id="problem_solving_c_good_new" name="problem_solving_c" value="good"></td>
                                                            <td class="text-center"><input class="form-check-input" type="radio"
                                            ...
                                            <div class="row mt-3">
                                                    ...
                                                    <div class="card p-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 mb-1">
                                                                <input type="text" class="form-control form-control-sm" id="strength_1"
                                                                       name="strength_1" placeholder="1">
                                                            </div>
                                                            <div class="col-12 mb-1">
                                                                <input type="text" class="form-control form-control-sm" id="strength_2"
                                                                       name="strength_2" placeholder="2">
                                                            </div>
                                                            <div class="col-12 mb-1">
                                                                <input type="text" class="form-control form-control-sm" id="strength_3"
                                                                       name="strength_3" placeholder="3">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="card p-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 mb-1">
                                                                <input type="text" class="form-control form-control-sm" id="improvement_1"
                                                                       name="improvement_1" placeholder="1">
                                                            </div>
                                                            <div class="col-12 mb-1">
                                                                <input type="text" class="form-control form-control-sm" id="improvement_2"
                                                                       name="improvement_2" placeholder="2">
                                                            </div>
                                                            <div class="col-12 mb-1">
                                                                <input type="text" class="form-control form-control-sm" id="improvement_3"
                                                                       name="improvement_3" placeholder="3">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-12">
                                                    <table class="table table-bordered table-sm">
                                                        ...
                                                        <tbody>
                                                        <tr>
                                                            <td class="text-center"><input class="form-check-input overall_standing" type="radio"
