        ...
        <form id="formAuthentication" class="mb-6" action="{{ route('register') }}" method="POST">
          ...
          <div class="mb-6">
            ...
            <input type="text" class="form-control @error('first_name') is-invalid @enderror" id="first_name" name="first_name"
              placeholder="johndoe" autofocus value="{{ old('first_name') }}" />
            @error('name')
            <span class="invalid-feedback" role="alert">
              <span class="fw-medium">{{ $message }}</span>
            </span>
          ...
          <div class="mb-6">
            ...
            <input type="text" class="form-control @error('middle_name') is-invalid @enderror" id="middle_name" name="middle_name"
              placeholder="johndoe" autofocus value="{{ old('middle_name') }}" />
            @error('name')
            <span class="invalid-feedback" role="alert">
              <span class="fw-medium">{{ $message }}</span>
            </span>
          ...
          <div class="mb-6">
            ...
            <input type="text" class="form-control @error('last_name') is-invalid @enderror" id="last_name" name="last_name"
              placeholder="johndoe" autofocus value="{{ old('last_name') }}" />
            @error('name')
            <span class="invalid-feedback" role="alert">
              <span class="fw-medium">{{ $message }}</span>
            </span>
          ...
          <div class="mb-6">
            <label for="username" class="form-label">Employee NUmber</label>
            <input type="text" class="form-control @error('employee_number') is-invalid @enderror" id="employee_number" name="employee_number"
              placeholder="johndoe" autofocus value="{{ old('name') }}" />
            @error('name')
            <span class="invalid-feedback" role="alert">
              <span class="fw-medium">{{ $message }}</span>
          ...
          <div class="mb-6">
            <label for="username" class="form-label">Detachment</label>
            <input type="text" class="form-control @error('detachment') is-invalid @enderror" id="detachment" name="detachment"
              placeholder="johndoe" autofocus value="{{ old('detachment') }}" />
            @error('name')
            <span class="invalid-feedback" role="alert">
              <span class="fw-medium">{{ $message }}</span>
            </span>
